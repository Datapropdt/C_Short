...
tot=m1+m2+m3;
avg=tot/3;
gotoxy(5,22);printf(" total  :  ");
gotoxy(20,22);printf("%f",tot);
gotoxy(5,23);printf(" average  :  ");
gotoxy(20,23);printf("%f",avg);fflush(stdin);
gotoxy(5,26);printf(" continue y/n :  ");
gotoxy(50,24);scanf("%c",&ans);
